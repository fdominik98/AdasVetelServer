...
namespace AdasVetelServer.dbHandler
{
    ...
    {
        private AdasVetelContext database;       


        public DbHandler()
        {
            database = new AdasVetelContext(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP_OMEN\source\repos\AdasVetelServer\AdasVetelServer\bin\Debug\AdasVetel.mdf;Integrated Security=True;Connect Timeout=30");
